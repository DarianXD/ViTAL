...
void DHT11_vTaskTempAndHumCalculate()
{
	...
	g_GET_DataStructure.u8Humidity = de_afis.u8IntegralHum;
	g_GET_DataStructure.u8Temperature = de_afis.u8IntegralTemp;

	ESP_LOGI(TAG, "temp: %d     humidity: %d", de_afis.u8IntegralTemp, de_afis.u8IntegralHum);
